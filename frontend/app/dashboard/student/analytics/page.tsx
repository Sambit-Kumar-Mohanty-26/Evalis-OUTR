        ...
        <motion.div key="internal" {...fadeUp(0)} className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <ChartCard
                    ...
                    subtitle="You vs Class Average vs Branch Highest"
                    icon={Users}
                    delay={0.3}
                    className="hover:scale-[1.01] transition-transform"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                >
                    <div className="text-[10px] font-black uppercase tracking-widest text-white/30 mb-3">Score Gap to Branch Highest</div>
                    <div className="text-4xl font-serif font-bold text-white">
                        {(data.classComparison[2]?.value - data.internalScore).toFixed(1)}
                        <span className="text-lg text-white/30">%</span>
                    </div>
                    <div className="text-xs text-white/30 mt-2">Branch Highest at {data.classComparison[2]?.value}%</div>
    ...
    return (
        <motion.div key="overall" {...fadeUp(0)} className="space-y-8">
            ...
            <ChartCard
                ...
                subtitle="Your SGPA vs class average and branch highest across all semesters"
                icon={Users}
                delay={0.55}
                className="hover:scale-[1.005] transition-transform"
            ...
            >
                <AnimatedLineChart
                    ...
                    dataKeys={[
                        ...
                        { key: "classAvg", color: "#3B82F6", name: "Class Average" },
                        { key: "highest",   color: "#8B5CF6", name: "Branch Highest" },
                    ]}
                    xKey="semester"
                    height={260}
                    yDomain={[5, 10]}
